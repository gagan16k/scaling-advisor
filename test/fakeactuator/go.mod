module github.com/gardener/scaling-advisor/test/fakeactuator
...
// Pin k8s.io minor versions to match the operator stack so the workspace
// builds consistently. Mirrors the replace block in operator/go.mod.
replace (
